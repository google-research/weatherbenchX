  ...
  def expand(
    ...
    for agg_name, agg in aggregators.items():
      ...
      res = (
          ...
          # filter the elements to the aggregator we want to write out the
          # aggregation state for.
          | f'FilterAggState{label_suffix}'
          >> beam.Filter(lambda x, name=agg_name: x[0].aggregator_name == name)
