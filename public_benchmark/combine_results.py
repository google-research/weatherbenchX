...
DETERMINISTIC = flags.DEFINE_bool(
    "deterministic", False, "Combine deterministic results."
)
PROBABILISTIC = flags.DEFINE_bool(
    "probabilistic", False, "Combine probabilistic results."
)
...
def main(_):
  if DETERMINISTIC.value == PROBABILISTIC.value:
    raise ValueError("Must specify either deterministic or probabilistic.")
  if DETERMINISTIC.value:
